...
import rondoAllaTurcaPic from "../refs/notes/rondo_alla_turca.svg";
import moonlightBeethovenPic from "../refs/notes/moonlight_sonata_3.svg";
import standchenSchubertPic from "../refs/notes/standchen.svg";
...
import anotherBrick from "../refs/music/rock/Pink_Floyd_Another_Brick_in_the_Wall.mp3";
import knockinOnHeavenDoor from "../refs/music/rock/Guns_Roses_Knockin_On_Heaven_Door.mp3";
...
export const musicEng = [
  [
    {
      ...
      song_name: "Für Elise",
      description: `Beethoven wrote Für Elise in 1810 as a small piece for the piano, and then put it
  ...
  [
    {
      ...
      description: `Familiar to many as the soundtrack to the film Eyes Wide Shut, Dmitri Shostakovich’s Waltz No. 2 
        ...
        qualities that call to mind circus or variety music.`,
      path: waltzNoTwo,
      //image: waltzNoTwoPic,
    },
    {
  ...
  [
    ...
    },
    {
      ...
      description: `The title could be used as a way to immerse yourself in what the music might be doing.
        ...
        and that is perhaps why it has stayed such a popular work for many years. Sometimes described 
        as new-age and new-classical in genre, this widely-accepted sub-form of classical music 
        has become very popular with other composers such as Ludovico Einaudi and Jon E Amber 
        producing music of a similar vein. Following the ideals of minimalism, less is always more with such compositions. 
        Strongly in the key of A major, River Flows in You opens with a tentative proclamation of the main melodic pattern. 
        There is a sense of holding back at the beginning here, like the music is unsure how much to play out. 
        The use of arpeggio runs, grace notes and the constant high register in both hands gives the gentle 
        and relaxing atmosphere to the piece. Persistence with the solo piano genre, the structure of this piece
        can be seen through the repetition of the different patterns. From the opening theme, 
    ...
    },
    {
      id: 23,
      song_artist: "Yann Tiersen",
      song_name: "Comptine d’un autre été l’après midi",
  ...
  [
    ...
    },
    {
      ...
      description: `"Still Loving You" is a power ballad by the German hard rock band Scorpions. 
    ...
    },
    {
      ...
      description: `The song has three sections, each one progressively increasing in tempo and volume. 
        ...
        solo (considered by many to be one of the greatest ever accompanying Plant's vocals that end with 
        the plaintive a cappella line: "And she's buying a stairway to heaven."`,
    ...
    },
    {
      ...
      song_name: "Just Another Brick in the Wall",
      description: `"Another Brick in the Wall" is a three-part composition on Pink Floyd's 1979 rock opera 
        The Wall, written by bassist Roger Waters. "Part 2", a protest song against corporal punishment, and 
        rigid and abusive schooling, features a children's choir. At the suggestion of producer Bob Ezrin, Pink
         Floyd added elements of disco. "Part 2" was released as a single, Pink Floyd's first in the UK since 
         "Point Me at the Sky" (1968). It sold over four million copies worldwide and topped singles charts in 
         fourteen countries, including in the UK and United States. It was nominated for a Grammy Award and was 
         ranked number 384 on Rolling Stone's list of "The 500 Greatest Songs of All Time".`,
      path: anotherBrick,
      //image: darkSidePic,
    },
    {
      ...
      song_name: "Knockin On Heaven Door",
      description: `Is a song by American singer-songwriter Bob Dylan, written for the soundtrack of the 1973
       film Pat Garrett and Billy the Kid. Released as a single two months after the film's premiere, it became
        a worldwide hit, reaching the Top 10 in several countries.`,
      path: knockinOnHeavenDoor,
      //image: knockingPic,
    },
    {
      id: 36,
